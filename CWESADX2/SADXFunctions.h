...
// void __usercall(ObjectMaster *a1@<edi>)
static const void *const OPropeller_Collision_InitPtr = (void*)0x60AB40;
static inline void OPropeller_Collision_Init(ObjectMaster *a1)
{
	__asm
	{
		mov edi, [a1]
		call OPropeller_Collision_InitPtr
	}
}
